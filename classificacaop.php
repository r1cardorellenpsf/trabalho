...
$sql02 = "SELECT timenome_idtimenome FROM palpite_posicao WHERE rodada_idrodada = '$idrodada' AND estado IS NOT NULL";
...
if (count($timesdef)==0) {
	...
	foreach($idusuarios as $i => $value) {
		$sql2 = "SELECT palpitepontorel FROM palpite WHERE palpitepontorel IS NOT NULL and usuario_idusuario = '$idusuarios[$i]' and rodada_idrodada = '$idrodada'";
		$res2 = mysqli_query($link, $sql2);

		$sql3 = "SELECT idpalpite FROM palpite WHERE palpitepontorel IS NOT NULL and usuario_idusuario = '$idusuarios[$i]' and rodada_idrodada = '$idrodada'";
		$res3 = mysqli_query($link, $sql3);

		$sql4 = "SELECT login FROM usuario WHERE idusuario = '$idusuarios[$i]'";
		$res4 = mysqli_query($link, $sql4);

		$sql5 = "SELECT palpiteponto FROM palpite WHERE palpitepontorel IS NOT NULL and usuario_idusuario = '$idusuarios[$i]' and rodada_idrodada = '$idrodada'";
